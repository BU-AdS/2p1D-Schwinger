...
int Ainv_psi(Complex psi[LX][LY][2], Complex b[LX][LY][2], Complex psi0[LX][LY][2], const Complex gauge[LX][LY][2], param_t p) {

  int success = 0;

  Complex res[LX][LY][2], pvec[LX][LY][2], Apvec[LX][LY][2];
...
int Ainv_psi(Complex psi[LX][LY], Complex b[LX][LY], Complex psi0[LX][LY], const Complex gauge[LX][LY][2], param_t p) {
